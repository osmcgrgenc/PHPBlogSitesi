...
<head>
    ...
    <title><?php echo html_escape($title); ?> - Yönetim Paneli</title>
            ...
            <div class="navbar-custom-menu">
                <a class="btn btn-sm btn-success pull-left btn-site-prev" target="_blank"
                   href="<?php echo base_url(); ?>"><i
                            class="fa fa-eye"></i> <?php echo html_escape($this->lang->line("admin_view_site")); ?></a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="header"><?php echo html_escape($this->lang->line("admin_navigation")); ?></li>
                <li>
                    <a href="<?php echo base_url(); ?>admin">
                        <i class="fa fa-home"></i>
                        <span><?php echo html_escape($this->lang->line("admin_home")); ?></span>
                    </a>
                </li>
                ...
                <?php if (is_admin()): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-leaf"></i> <span><?php echo html_escape($this->lang->line("admin_pages")); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active">
                                <a href="<?php echo base_url(); ?>admin/add-page">
                                    <i class="fa fa-circle-o"></i> <?php echo html_escape($this->lang->line("admin_add_new_page")); ?>
                                </a>
                            </li>
                            ...
                            <?php foreach ($pages as $page): ?>
                                <li>
                                    <a href="<?php echo base_url(); ?>admin/update-page/<?php echo html_escape($page->id); ?>">
										...
										<?php 
											if(!empty($this->lang->line("admin_".$page->slug)))
												echo html_escape($this->lang->line("admin_".$page->slug)); 
											else
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-file"></i> <span><?php echo html_escape($this->lang->line("admin_posts")); ?></span> <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li class="active">
                            <a href="<?php echo base_url(); ?>admin/add-post">
                                <i class="fa fa-circle-o"></i> <?php echo html_escape($this->lang->line("admin_add_new_post")); ?>
                            </a>
                        </li>
						<li>
							<a href="<?php echo base_url(); ?>admin/categories">
								<i class="fa fa-circle-o"></i> <span><?php echo html_escape($this->lang->line("admin_categories")); ?></span>
							</a>
						</li>
                        <li>
                            <a href="<?php echo base_url(); ?>admin/posts"><i class="fa fa-circle-o"></i> <?php echo html_escape($this->lang->line("admin_posts")); ?>
                            </a>
                        </li>
                ...
                <?php if (is_admin()): ?>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-image"></i> <span><?php echo html_escape($this->lang->line("admin_photo_gallery")); ?></span>
                            <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>admin/gallery-categories">
                                    <i class="fa fa-circle-o"></i> <?php echo html_escape($this->lang->line("admin_categories")); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>admin/photo-gallery">
                                    <i class="fa fa-circle-o"></i> <?php echo html_escape($this->lang->line("admin_photos")); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>admin/comments">
                            ...
                            <span><?php echo html_escape($this->lang->line("admin_comments")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/contact-messages">
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            <span><?php echo html_escape($this->lang->line("admin_messages")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/newsletter">
                            <i class="fa fa-envelope" aria-hidden="true"></i>
                            <span><?php echo html_escape($this->lang->line("admin_newsletter")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/ads">
                            <i class="fa fa-dollar" aria-hidden="true"></i>
                            <span><?php echo html_escape($this->lang->line("admin_ad_spaces")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/users"><i class="fa fa-users"></i>
                            <span><?php echo html_escape($this->lang->line("admin_users")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/font-options"><i class="fa fa-font" aria-hidden="true"></i>
                            <span><?php echo html_escape($this->lang->line("admin_font_options")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/seo-tools"><i class="fa fa-wrench"></i>
                            <span><?php echo html_escape($this->lang->line("admin_seo_tools")); ?></span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/settings">
                            <i class="fa fa-cogs"></i>
                            <span><?php echo html_escape($this->lang->line("admin_settings")); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
